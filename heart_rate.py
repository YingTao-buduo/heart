...
def get_heart_rate_variability(heart_rate_frame_data, fps):
    ...
    heart_rates.append(fps * 60 / max(heart_rate_distance))  # MIN
    heart_rates.append(fps * 60 / min(heart_rate_distance))  # MAX
    heart_rates.append(fps * 60 / avg_interval)              # AVG
